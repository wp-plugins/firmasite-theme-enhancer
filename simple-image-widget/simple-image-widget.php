...
class FirmaSite_Simple_Image_Widget_Loader {
	...
	public static function load_textdomain() {
		$locale = apply_filters( 'plugin_locale', get_locale(), "firmasite-theme-enhancer" );
		load_textdomain( "firmasite-theme-enhancer", WP_LANG_DIR . '/simple-image-widget/' . $locale . '.mo' );
	...
	public static function init() {
		wp_register_script( "firmasite-theme-enhancer", plugin_dir_url( __FILE__ ) . 'js/simple-image-widget.js', array( 'media-upload', 'media-views' ) );

		wp_localize_script( "firmasite-theme-enhancer", 'SimpleImageWidget', array(
	...
	public static function admin_scripts( $hook_suffix ) {
		if ( 'widgets.php' == $hook_suffix ) {
			wp_enqueue_media();
			wp_enqueue_script( "firmasite-theme-enhancer" );
		}
	}
